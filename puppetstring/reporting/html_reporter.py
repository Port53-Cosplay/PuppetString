"""HTML report renderer — produces a self-contained HTML report."""
...
def render_html_report(
    ...
    Args:
        ...
        report_config: Report configuration (company name, transcripts, etc.).
    ...
    out_path = out_dir / f"puppetstring_report_{datetime.now():%Y%m%d_%H%M%S}.html"
...
def _build_template_context(
    ...
    """Build the Jinja2 template context from a DanceRunResult."""
    categories = []
